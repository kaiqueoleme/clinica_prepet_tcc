...
<head>
    ...
    <title>Login Funcionário - Clínica PrePet</title>
...
<body class="w3-light-grey">
    ...
    <div class="w3-container w3-padding-64 w3-center">
        <div class="w3-card-4 w3-white w3-padding-large w3-round-large w3-display-middle" style="width:90%;max-width:400px;">
            <h2><i class="fa fa-user-circle"></i> Login Funcionário</h2>
            ...
            <form action="../Controller/Navegacao.php" method="post">
                ...
                <p>
                    <select class="w3-select w3-border" name="option_acesso" required>
                        <option value="" disabled selected>Nível de Acesso</option>
                        <option value="2">Atendente/Recepcionista</option>
                        <option value="3">Veterinário</option>
                    </select>
                </p>
                <p><button name="btnLogarFuncionario" class="w3-button w3-black w3-block w3-round-large">Entrar</button></p>
            </form>
        </div>
    </div>
