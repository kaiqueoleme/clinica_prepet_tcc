...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-cyan w3-animate-left" style="z-index:3;width:250px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            <a href="../View/dashboardAtendente.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-dashboard fa-fw"></i>  Dashboard</a>
            <a href="../View/listaPaciente.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-paw fa-fw"></i>  Pacientes</a>
            <a href="../View/agendamentoConsulta.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-calendar-plus-o fa-fw"></i>  Agendar Atendimento</a>
            <a href="../View/listaEstoque.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-cubes fa-fw"></i>  Consultar Estoque</a>
            <a href="../View/atendenteCadastrarPessoa.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user-plus fa-fw"></i> Cadastrar Pessoa</a>
            <a href="../View/atendenteCadastrarPet.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-paw fa-fw"></i> Cadastrar Pet</a>
            <a href="../View/atendenteListarPessoas.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i> Listar Clientes</a>
                        ...
                        <tbody>
                            <?php foreach ($agendamentos as $agendamento): ?>
                                <tr>
                                    ...
                                    <td class="w3-center">
                                        <a href="../View/editarAgendamento.php?id=<?php echo htmlspecialchars($agendamento['id']); ?>" class="w3-button w3-center w3-blue w3-tiny w3-round" title="Editar Agendamento">
