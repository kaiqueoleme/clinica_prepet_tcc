...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;" id="mySidebar"><br>
            ...
            <div class="w3-col s8 w3-bar">
                ...
                <p><a href="alterarDadosUsuario.php" class="w3-button w3-white w3-round-large">Alterar Cadastro</a></p>
            </div>
        </div>
        <hr>
        ...
        <div class="w3-bar-block">
            ...
            <a href="veterinarioCadastrarPessoa.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user-circle-o fa-fw"></i>  Cadastrar Tutor</a>
            <a href="veterinarioCadastrarPet.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-paw fa-fw"></i>  Cadastrar Paciente</a>
            <a href="veterinarioVerHistorico.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-history fa-fw"></i>  Histórico de Pacientes</a>
            <a href="listaEstoqueVet.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-cubes fa-fw"></i> Gerenciar Estoque</a>
