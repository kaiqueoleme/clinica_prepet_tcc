<?php
// View/atendenteCadastrarPessoa.php
...
<head>
    ...
    <title>Cadastrar Nova Pessoa - PrePet</title>
    ...
    <style>
        ...
        .header-view { background-color: #007bff; color: white; margin-bottom:20px; }
        .w3-button.w3-green { background-color: #28a745 !important; }
        ...
        <div class="w3-card-4 w3-white w3-round-large form-card">
            ...
            <form action="/prepet/Controller/Navegacao.php" method="post" class="w3-container w3-padding-16">
                ...
                <div class="w3-row-padding">
                    <div class="w3-half">
                        <button type="submit" name="btnAtendenteCadastraPessoa" class="w3-button w3-green w3-block w3-round-large w3-padding">
