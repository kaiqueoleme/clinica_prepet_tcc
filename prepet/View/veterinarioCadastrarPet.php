<?php
// View/veterinarioCadastrarPet.php
...
// Usaremos o método que lista todas as pessoas que podem ser tutores
...
<head>
    ...
    <title>Cadastrar Novo Pet (Veterinário) - PrePet</title>
            ...
            <form action="/prepet/Controller/Navegacao.php" method="post" class="w3-container w3-padding-16">
                <p>
                    ...
                    <select id="id_pessoa_tutor" name="id_pessoa_tutor" required>
                        ...
                        <?php if (!empty($listaPessoasParaSelecao)): ?>
                            <?php foreach ($listaPessoasParaSelecao as $pessoa): ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <option value="" disabled>Nenhuma pessoa encontrada. Cadastre uma pessoa primeiro.</option>
                        <?php endif; ?>
                    </select>
                </p>
                <hr>
                ...
                <div class="w3-row-padding">
                    <div class="w3-half">
                        <button type="submit" name="btnVeterinarioCadastraPet" class="w3-button w3-green w3-block w3-round-large w3-padding">
