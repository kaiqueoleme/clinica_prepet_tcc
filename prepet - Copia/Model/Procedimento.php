<?php
// C:\xampp\htdocs\prepet\Model\Procedimento.php
...
class Procedimento {
     ...
     * @return bool True se o procedimento foi inserido com sucesso, false caso contrário.
     */
    public function inserir(): bool {
        ...
        $stmt->bind_param(
            "sssssii", // tipo (s), data (s), resultado (s), status (s), diagnostico (s), id_vet (i), id_pac (i)
            $this->tipo,
     ...
     * @return array|null Dados do procedimento ou null se não encontrado.
     */
     ...
     * @return array Uma lista de procedimentos do paciente.
     */
    ...
    // Você pode adicionar métodos para 'atualizar' e 'excluir' procedimentos mais tarde, se necessário.
}
?>