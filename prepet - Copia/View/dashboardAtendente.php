...
// --- NOVAS LINHAS PARA LISTAR AGENDAMENTOS ---
...
<nav class="w3-sidebar w3-collapse w3-cyan w3-animate-left" style="z-index:3;width:250px;" id="mySidebar"><br>
    <div class="w3-container w3-row">
        ...
        <div class="w3-col s8 w3-bar">
            ...
            <a href="#" class="w3-bar-item w3-button"><i class="fa fa-user"></i>  Meu perfil</a>
            <a href="#" class="w3-bar-item w3-button"><i class="fa fa-cog"></i>  Config.</a>
        </div>
    </div>
    <hr>
                    ...
                    <tbody>
                        <?php foreach ($agendamentos as $agendamento): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/prepet/View/editarAgendamento.php?id=<?php echo htmlspecialchars($agendamento['id']); ?>" class="w3-button w3-blue w3-tiny w3-round" title="Editar Agendamento">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="/prepet/Controller/Navegacao.php" method="post" style="display:inline;" onsubmit="return confirm('Tem certeza que deseja cancelar este agendamento?');">
                                        <input type="hidden" name="id_agendamento" value="<?php echo htmlspecialchars($agendamento['id']); ?>">
                                        <button type="submit" name="btnCancelarAgendamento" class="w3-button w3-red w3-tiny w3-round" title="Cancelar Agendamento">
