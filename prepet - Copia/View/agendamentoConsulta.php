...
// Remover require_once '../Model/Pessoa.php'; daqui, pois o Controller já faz o join
// e o modelo Pessoa não é instanciado diretamente para buscar o nome do tutor.
require_once '../Model/Paciente.php';
require_once '../Model/Veterinario.php'; // Adicionei este require, pois ele precisa para carregar os veterinários.
require_once '../Controller/PacienteController.php'; // Para listar pacientes
// O Controller de Pessoa não é estritamente necessário aqui se o PacienteController já te dá o nome do tutor

$nomeFuncionario = $_SESSION['usuario_logado'];

$pacienteController = new PacienteController();
$veterinarioModel = new Veterinario(); // Usando o Model Veterinario para listar veterinários

// Listar todos os pacientes e seus tutores para o select
// AQUI ESTÁ A MUDANÇA: O nome do tutor já vem do controller
$todosPacientes = $pacienteController->listarTodosPacientes(); // Esta linha está correta assim!

// Listar todos os veterinários para o select
